...
#include "..\headers\usb_stack_globals.h"     // USB stack only defines Not function related.
...
const BYTE *usb_device_descriptor;
const BYTE *usb_config_descriptor;
const BYTE *usb_string_descriptor;
